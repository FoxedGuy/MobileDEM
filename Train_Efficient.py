...
from models import create_discriminator, create_generator_efficient
...
generator = create_generator_efficient()
...
def fit(train_ds, test_ds, epochs):
    ...
    for epoch in range(epochs):
        ...
        save_images(generator, example_input, example_target, epoch, './results_efficient')
